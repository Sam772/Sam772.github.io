...
const FiverrCard = (props: IProps) => {
  return (
    <div className='fiverr-card-body'>
        ...
        <a href ={props.url} className="mt-2 mx-24 mb-4 group [transform:translateZ(0)] px-4 py-2 rounded-lg overflow-hidden bg-gray-200 relative before:absolute before:bg-emerald-600 before:top-1/2 before:left-1/2 before:h-8 before:w-10 before:-translate-y-1/2 before:-translate-x-1/2 before:rounded-full before:scale-[0] before:opacity-0 hover:before:scale-[6] hover:before:opacity-100 before:transition before:ease-in-out before:duration-500" target="_blank" rel="noopener noreferrer">
          <div className='relative z-0 text-emerald-600 group-hover:text-gray-400 transition ease-in-out duration-500 text-lg'>
            Check out my Gigs
          </div>
        </a>
    </div>
